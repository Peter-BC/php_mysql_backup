...
class Db{
  ...
  public static  $connid;
  public static function __init($dbhost, $dbuser, $dbpass, $dbname, $dbport) {
    //echo "mysqli_connect($dbhost, $dbuser, $dbpass, $dbname, $dbport)";exit;
    self::$connid = mysqli_connect($dbhost, $dbuser, $dbpass, $dbname, $dbport);
    mysqli_query(self::$connid, "SET sql_mode=''");

    if($dbname) {
      if(!@mysqli_select_db(self::$connid, $dbname)){
        exit('Cannot use database '.$dbname);
      }
    }
  }
  public static function execute($sql) {
    return mysqli_query(self::$connid, $sql);
  }
...
class Database
{
    ...
    public function create(){
        ...
        $sql .= "--\n";
        $sql .= "-- Host     : " . $this->config['database.hostname'] . "\n";
        $sql .= "-- Port     : " . $this->config['database.hostport'] . "\n";
